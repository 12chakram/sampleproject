...
import com.gridpoint.energy.util.sql.PostgresArray;
        ...
        implements UserType
{
    ...
    public static void setIsTestMode (boolean isTestMode) {
        IntArrayType.isTestMode = isTestMode;
    }

    public static boolean isTestMode(){
        return IntArrayType.isTestMode;
    }
    ...
    */
    ...
    public boolean equals(Object x, Object y) throws HibernateException {
        return ( x == null ) ? ( y == null ) : Arrays.equals( (int[])x, (int[])y );
    }
    ...
    public Object nullSafeGet(ResultSet rs, String [] names, Object owner) throws HibernateException, SQLException {
        ...
        if( isTestMode ) {
            ...
            Integer[] preArray = (Integer[])sqlArray.getArray(); //comes as objects
            int[] result = new int[ preArray.length ];
            for( int x=0;x<preArray.length;x++) {
                result[x] = preArray[x]; //NOTE: Null is not supported and should throw an exception. (by design)
            }
            return( result );
        }
    }
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index)
        ...
        if( isTestMode ) {
            ...
            st.setArray(index, PostgresArray.createArray( (int[]) deepCopy(value) ));
        }
    }
