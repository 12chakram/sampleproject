...
public class DoubleArrayType implements UserType
{
    ...
    private static final int [] TEST_SQL_TYPES = { Types.BINARY };
    ...
    public static void setIsTestMode (boolean isTestMode) {
        DoubleArrayType.isTestMode = isTestMode;
    }

    public static boolean isTestMode(){
        return DoubleArrayType.isTestMode;
    }
    ...
    public boolean equals(Object x, Object y) throws HibernateException {
        return ( x == null ) ? ( y == null ) : Arrays.equals( (Double[])x, (Double[])y );
    }
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index)
        ...
        if( isTestMode ) {
            ...
            st.setArray(index, PostgresArray.createArray( (Double[]) deepCopy(value) ));
        }
    }
